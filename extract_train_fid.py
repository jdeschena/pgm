...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset",  type=str, default="imagenet",  help="data source")
    ...
    data_loader = get_data(
        args.dataset, img_size=args.img_size, data_folder=args.data_folder, bsize=args.bsize,
        num_workers=args.num_workers, is_multi_gpus=False, seed=-1, args=args
    )[1]
